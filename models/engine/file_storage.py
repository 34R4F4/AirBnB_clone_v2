#!/usr/bin/python3
"""
Contains the FileStorage class for serialization and deserialization.
"""
...
class FileStorage:
    ...
    def save(self):
        ...
        for key in self.OBJECTS_DICT:
            json_objects[key] = self.OBJECTS_DICT[key].to_dict(
                    save_to_disk=True)
    ...
    def reload(self):
        ...
        try:
            ...
            for key in json_objects:
                self.OBJECTS_DICT[key] = CLASSES_MAP[json_objects[key][
                    "__class__"]](**json_objects[key])
