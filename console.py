...
class HBNBCommand(cmd.Cmd):
    """ Provides functionality for the HBNB console"""

    # sets prompt for interactive/non-interactive modes
    ...
    # dictionary of accepted data types for attributes
    types = {
    ...
    def do_update(self, args):
        ...
        ''' Isolate class name from id/arguments,
        ex: (<class>, delimiter, <id/args>)'''
        args = args.partition(" ")
        if args[0]:
            class_name = args[0]
        ...
        # First determine if kwargs or arguments
        if '{' in args[2] and '}' in args[2] and type(eval(args[2])) is dict:
            ...
            # If att_val was not quoted argument
